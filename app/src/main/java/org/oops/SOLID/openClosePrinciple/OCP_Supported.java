package org.oops.SOLID.openClosePrinciple;
...
class SaveToMongo implements Persistence{
    ...
    public SaveToMongo(ShoppingCartImpl shoppingCart) {
        this.shoppingCart = shoppingCart;
    }
...
class SaveToFile implements Persistence{
    ...
    public SaveToFile(ShoppingCartImpl shoppingCart) {
        this.shoppingCart = shoppingCart;
    }
...
public class OCP_Supported {
    public static void main(String[] args) {
        ...
        SaveToMongo saveToMongo = new SaveToMongo(cart);
        saveToMongo.save();

        SaveToFile saveToFile = new SaveToFile(cart);
        saveToFile.save();
    }
}
